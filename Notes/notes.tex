...
Find an incorrectly used word in the description of this Class Activity. \\\\
  ...
  \chapter{Day 11 - 01/02/2024} % (fold)
  \label{chap:Day 11 - 01/02/2024}
    \section{Question Tags} % (fold)
  ...
  \chapter{Day 12 - 02/02/2024} % (fold)
    \label{chap:Day 12 - 02/02/2024}
      Today we were taught \textbf{Reporting of speech}. The Book is in the Materials/Book folder, refer to units 32 - 37 (75 - 85).\\\\ 
      After that, we did \textbf{Subject-Verb-Agreement}. refer to units 40.\\\\
    % chapter Day 12 - 02/02/2024 (end)
   
    % section Question Tags (end)
  
  % chapter Day 11 - 01/02/2024 (end)

  \chapter{Day 13 - 06/02/2024}
    \section{Paragraph Writing!} 
      \href{https://www.weekendpublisher.com/how-to-write-a-descriptive-paragraph/}{\textbf{Instructions?}}\\\\
      \href{https://wts.indiana.edu/writing-guides/paragraphs-and-topic-sentences.html}{\textbf{More Material}}\\\\
      \href{https://academichelp.net/blog/really-bad-writing.html}{\textbf{Bad Writing Manual}}\\\\
      (\textbf{CheatSheet in Materials/Day13 folder})


  \chapter{Day 14 - 07/02/2024}
    \section{Paragraph Writing Continued...} 
      \begin{itemize}
        \item Try not to include random disconnected/out of context sentences. 
        \item Try not to be too self centered (me! me! me!). 
      \end{itemize}
      
      \textbf{Example-1} - She looked as if she was struck by lightning: her eyes going to fall out of orbits, her mouth wide open, as if she was trying to swallow a train, her skin deadly pale. To me, seeing her in such a condition was heartbreaking, like eggs being cracked upon a stone.\\\\
      So whats wrong here? - \textbf{Metaphors} and \textbf{comparisons} can be okay if you use them once every few pages. But back to back, they can be annoying—especially poorly-used metaphors.\\\\
      Some more examples were also discussed, all of them listed on the site above (Bad Writing Manual). \\\\
      After that, the assignment of paragraph writing was discussed.\\\\
  
  \chapter{Day 15 - 12/02/2024} % (fold)
  \label{chap:Day15 : 12/02/2024}
    \section{Active vs Passive Voice}
      Book page 55.\\\\
  % chapter Day15 : 12/02/2024 (end)
\end{document} 
